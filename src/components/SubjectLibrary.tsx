...
const SubjectCard = ({ name, idx }: { name: string; idx: number }) => (
  <motion.div
    ...
    className="card-elevated rounded-xl p-5 card-hover group flex flex-col justify-between"
  >
    <h4 className="font-semibold text-sm text-card-foreground mb-3">{name}</h4>
...
const SubjectLibrary = () => (
  <section className="py-24 section-light" id="subjects">
    <div className="container mx-auto px-6">
      <div className="text-center mb-14">
        <h2 className="font-display text-3xl sm:text-4xl italic mb-4">
          Complete <span className="text-accent">Subject Library</span>
        </h2>
      ...
      <div className="mb-12">
        <h3 className="text-lg font-semibold mb-5 flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-primary" /> Core CSE
        </h3>
